            ...
            <div className="flex gap-6">
              ...
              <div className="flex flex-col gap-2 flex-1">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Input className="min-w=[120px]" name="hourStart" id="hourStart" type="time" placeholder="De" />
                  <Input className="min-w=[120px]" name="hourEnd" id="hourEnd" type="time" placeholder="Até" />
                </div>
              </div>
            </div>
